...
function setupSiteMusic() {
    ...
    player.innerHTML = `
        <button class="site-music-player__toggle" id="weddingMusicToggle" type="button" aria-pressed="false">
            <span class="site-music-player__icon" aria-hidden="true">?</span>
            <span class="site-music-player__label">Play our song</span>
        </button>
    `;
    document.body.appendChild(player);

    const toggle = player.querySelector("#weddingMusicToggle");
    const label = player.querySelector(".site-music-player__label");

    const syncUi = (isPlaying) => {
        toggle.setAttribute("aria-pressed", String(isPlaying));
        player.classList.toggle("is-playing", isPlaying);
        label.textContent = isPlaying ? "Pause our song" : "Play our song";
    };
